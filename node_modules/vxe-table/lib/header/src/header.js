...
var _default = {
    ...
    h('thead', {
      ...
      return h('tr', {
        ...
        return h('th', {
          ...
          style: headerCellStyle ? _xeUtils.default.isFunction(headerCellStyle) ? headerCellStyle({
            $table: $table,
            $rowIndex: $rowIndex,
            column: column,
            columnIndex: columnIndex,
  ...
  methods: {
    ...
    resizeMousedown: function resizeMousedown(evnt, params) {
      ...
      _tools.DomTools.addClass($table.$el, 'c--resize');
      ...
      document.onmouseup = function (evnt) {
        ...
        _tools.DomTools.removeClass($table.$el, 'c--resize');
