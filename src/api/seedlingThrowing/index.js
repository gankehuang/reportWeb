...
export function getForNew(params) {
    return request({
        url: PATH + '/rhseedplsum/getForNew',
        method: 'get',
        params: params
    })
}
...
export function getDetail(params) {
    return request({
        url: PATH + `/rhseedplsum/getById/${params}`,
        method: 'get',
    })
}
